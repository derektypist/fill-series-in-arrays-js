...
let arithmetic = (e) => Array(e).fill(0).map((e,i) => i+3);
let geometric = (e) => Array(e).fill(0).map((e,i) => Math.pow(2,i));
let isMultOf3Or5 = (e) => Array(e+1).fill(0).map((e,i) => i%3==0 || i%5 == 0 ? true : false);
let multOf3Or5 = (e) => Array(e+1).fill(0).map((e,i) => i%3==0 || i%5 == 0 ? i : 0);
...
txt += `Arithmetic Progression: ${arithmetic(10)} <br>`;
